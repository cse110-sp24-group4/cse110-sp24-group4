...
function initTodoList() {
  ...
  document.getElementById("add-task-button").addEventListener("click", () => addTask(projectId));
...
function addTask(projectId) {
  ...
  const newTask = { id: `${projectId}#task#${Date.now()}`, name: newTaskName, completed: false };
  tasks.push(newTask);
